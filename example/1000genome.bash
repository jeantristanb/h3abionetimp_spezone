...
#nextflow  run ../imputed_data_beagle.nf --vcf $file_vcfi --maf 0.01 --chr $chr --from_bp $begin37r --to_bp $end37r  -profile slurm --bed pos_cheap --shapeit_ref reference_panel/shapeit/format/refpanel_phaseshapeit --vcf_ref reference_panel/beagle/refpanel_phasebeagle.vcf.gz  #--refpanel_bref3 reference_panel/beagle/refpanel_phasebeagle.bref3
nextflow  run ../imputed_data_beagle.nf --vcf $file_vcfi --maf 0.01 --chr $chr --from_bp $begin37r --to_bp $end37r  -profile slurm --bed pos_cheap --vcf_ref reference_panel/beagle/refpanel_phasebeagle.vcf.gz  -resume #--refpanel_bref3 reference_panel/beagle/refpanel_phasebeagle.bref3
